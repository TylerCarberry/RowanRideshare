...
Future<Post> getPost() async {
  String postUrl = 'http://e4325b2b.ngrok.io/rides/profile/1';
  final response = await http.get(postUrl);
  return postFromJson(response.body);
}

Future<Address> getAddressPost() async {
  String addressUrl = 'http://e4325b2b.ngrok.io/rides/address/1';
...
Future<http.Response> createAddress(Address address) async {
  String updateUrl = 'http://e4325b2b.ngrok.io/rides/address/update';
