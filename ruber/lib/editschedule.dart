...
Future<Post> getPost() async {
  String postUrl = BASE_URL + '/rides/profile/7';
...
//  String updateUrl = BASE_URL + '/rides/profile/7/schedule/update';
...
Future<http.Response> newSchedule(NewSchedule newSchedule) async {
  String updateUrl = BASE_URL + '/rides/profile/1/schedule/new';
  final response = await http.post('$updateUrl',
      headers: {
        HttpHeaders.contentTypeHeader: 'application/json',
        HttpHeaders.authorizationHeader: ''
